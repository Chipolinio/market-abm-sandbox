# Pydantic-конфиг генерации buyers_df: распределения scipy и категориальные веса (без логики сэмплинга).
"""Модели валидируют вход симуляции; агенты по-прежнему только строки DataFrame."""
