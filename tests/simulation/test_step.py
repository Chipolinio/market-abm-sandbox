...
def test_step_returns_products_and_transactions_with_expected_columns() -> None:
    ...
    products_next, transactions = step(buyers, sellers, products, _step_config())
...
def test_transactions_reference_valid_buyer_and_listing_ids() -> None:
    ...
    _, transactions = step(buyers, sellers, products, _step_config(seed=7))
...
def test_step_prices_stay_above_floor() -> None:
    ...
    products_next, _ = step(buyers, sellers, products, _step_config(seed=11))
...
def test_demand_index_uses_normalized_sales_formula() -> None:
    ...
    products_next, transactions = step(buyers, sellers, products, cfg)
...
def test_rating_maximizer_price_unchanged_on_active_tick() -> None:
    ...
    products_next, _ = step(buyers, sellers, products, cfg)
